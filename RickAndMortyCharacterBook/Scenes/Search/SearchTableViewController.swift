...
final class SearchTableViewController: UIViewController, Sendable {
    ...
    private let searchBarView = TextFieldView()
    ...
    override func viewDidLoad() {
        ...
        tableView.register(CharacterSearchCell.self, forCellReuseIdentifier: CharacterSearchCell.identifier)
...
extension SearchTableViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if searchedCharacters.count <= 0 && indexPath.row == 0 {
            ...
            tableView.separatorColor = .main
            let cell = tableView.dequeueReusableCell(withIdentifier: CharacterSearchCell.identifier, for: indexPath) as! CharacterSearchCell
